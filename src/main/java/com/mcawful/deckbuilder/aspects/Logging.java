...
public class Logging {
	...
	private static Logger repoLog = LogManager.getLogger("Repo");
	private static Logger serviceLog = LogManager.getLogger("Service");
	private static Logger controllerLog = LogManager.getLogger("Controller");
	private static Logger utilLog = LogManager.getLogger("Util");
	...
	private void afterReturning(JoinPoint jp, Object rtn, Logger log) {
		...
		if (rtn != null) {
			...
			log.info("Returned: " + objStr + " - " + jp.getSignature());
